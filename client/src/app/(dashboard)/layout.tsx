...
const accessControl = {
  admin: ["/admin", "/list/teachers", "/list/students", "/list/parents", "/list/subjects", "/list/classes", "/list/lessons", "/list/subject-teacher", "/list/assignments", "/list/results", "/list/attendance", "/list/messages", "/list/announcements", "/list/student-lessons"],
