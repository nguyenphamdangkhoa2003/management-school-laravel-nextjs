  ...
  const Form = () => {
    const handleDelete = async (e: React.FormEvent) => {
      ...
      try {
        ...
        if (table === "subjectteacher") {
          setErrorMessage("Không thể xóa môn học đang dạy này!");
        }
    ...
    <>
      ...
      {open && (
        <div className="w-screen h-screen absolute left-0 top-0 bg-black bg-opacity-60 z-50 flex items-center justify-center">
          <div className="bg-white p-4 rounded-md relative w-[90%] max-h-[calc(100vh-4rem)] overflow-scroll scrollbar-none md:w-[70%] lg:w-[60%] xl:w-[50%] 2xl:w-[40%]">
            <Form />
            <div
